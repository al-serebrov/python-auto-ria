...
class RiaAverageCarPrice:
    ...
    def __init__(self, category: str, mark: str, model: str,
        ...
        self._params['body_id'] = self.select_item(bodystyle, bodystyles_list)
        ...
        self._params['model_id'] = self.select_item(model, models_list)

        # Getting list of states and selecting needed id
        states_list = self._api.get_states()
        self._params['state_id'] = self.select_item(state, states_list)
